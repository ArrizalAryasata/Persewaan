...
import Lapangan from '../image/futsal.jpg';
                ...
                <div className="card h-100" style={{ marginBottom: "10px"}}>
                    <a href="#"><img className="card-img-top" src={Lapangan} alt="" /></a>
                        <div className="card-body">
                            ...
                            <h5>Rp. {item.harga}</h5>
                            <h5><span className="fa fa-map-marker"></span> Sawojajar</h5>
                            <h5><span className="fa fa-phone"></span> 0812-3347-6922</h5>
                            <span className="card-text">
                                <h5>Tersedia:  2 Lapangan</h5>
                            </span>
                            <br/>
